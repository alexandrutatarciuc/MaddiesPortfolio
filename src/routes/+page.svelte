	...
	{#if isPageLoaded}
		<div class="relative">
			...
			<svg
				...
				class="absolute -translate-y-1/2 translate-x-1/2 right-0 top-36 h-[3.5rem] sm:h-[5.75rem] xl:h-[6.75rem] shape-shadow transition-transform ease-in-out duration-500 hover:-rotate-[30deg]"
				viewBox="0 0 195 112"
				fill="none"
			...
			<svg
				transition:spin
				class="absolute -left-12 sm:-left-28 -top-14 sm:-top-28 w-auto h-[6rem] sm:h-[12rem] shape-shadow transition-transform ease-in-out duration-1000 hover:rotate-[360deg]"
				viewBox="0 0 295 295"
				fill="none"	
				xmlns="http://www.w3.org/2000/svg">
				<path
			...
			<svg
				...
				class="absolute -bottom-14 sm:-bottom-24 -left-12 sm:-left-28 h-[6.25rem] sm:h-[10.5rem] shape-shadow transition-transform ease-in-out duration-1000 hover:rotate-[360deg]"
				viewBox="0 0 228 228"
				fill="none"
				xmlns="http://www.w3.org/2000/svg">
				<path
