...
<section class="w-full flex justify-center items-center h-screen px-6 sm:px-8 md:px-15 lg:px-auto overflow-hidden">
    <div class="relative text-display border-2 border-gray-900 rounded-2xl mx-auto px-4 sm:px-8 md:px-10 lg:px-15 py-12 sm:py-19 flex flex-col gap-10 max-w-[70rem] hi-section">
        <h1 class="font-display text-center font-semibold text-3xl sm:text-5xl md:text-6xl lg:text-[5.25rem] lg:leading-none xl:text-8xl">
            ...
            <br>
            <div class="sm:mt-5">
                A <span class="bg-button inline-block text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl transform -rotate-6 outline-offset-[-6px] sm:outline-offset-[-8px] lg:outline-offset-[-10px] xl:outline-offset-[-14px] inline-tag p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 rounded-full ml-1 mr-3 lg:ml-2 lg:mr-6">UX/UI</span>Designer.
            </div>
        </h1>
        <p class="text-xl md:text-2xl font-display font-500 text-center">
            My purpose is to give voice to overlooked perspectives, fostering meaningful connections and inclusivity. 
            I channel my skills to support those with meaningful projects, ensuring their visions reach a wider audience.
        </p>
        <!-- Eye-shape -->
        <svg class="absolute -right-8 sm:-right-28 inset-y-36 max-w-[65px] max-h-[58px] sm:max-w-[195px] sm:max-h-[112px] shape-shadow" viewBox="0 0 195 112" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M185.426 91.6802C164.144 102.289 123.058 118.151 83.7364 107.425C44.4146 96.6995 17.0737 62.1725 4.12569 42.2273C-0.776596 34.6757 1.8513 25.0416 9.90896 21.0251C31.191 10.4168 72.2765 -5.44576 111.598 5.27998C150.92 16.0057 178.261 50.5328 191.209 70.4778C196.111 78.0294 193.483 87.6636 185.426 91.6802ZM87.5014 93.6225C108.085 99.2371 129.323 87.1024 134.937 66.5185C140.552 45.935 128.417 24.6972 107.833 19.0826C87.2499 13.4681 66.0122 25.6029 60.3977 46.1864C54.783 66.7704 66.9178 88.008 87.5014 93.6225Z" fill="#F7AEF8" stroke="#111111" stroke-width="2"/>
        </svg>
        <!-- Flower shape -->
        <svg class="absolute -translate-y-1/2 -translate-x-1/2 -top-2 sm:-top-6 -left-2 sm:-left-6 max-w-[77px] max-h-[95px] sm:max-w-[295px] sm:max-h-[295px] shape-shadow" viewBox="0 0 295 295" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Small cloud shape -->
        <svg class="absolute translate-y-1/2 -translate-x-1/2 -bottom-2 sm:-bottom-6 left-0 sm:-left-20 max-w-[74px] max-h-[97px] sm:max-w-[228px] sm:max-h-[228px] shape-shadow" viewBox="0 0 228 228" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M45.6865 93.4472L46.5728 92.984L46.1096 92.0977L37.0929 74.8458C24.277 50.3244 33.7661 20.0565 58.2875 7.24047C82.8089 -5.57552 113.077 3.9136 125.893 28.435L134.909 45.6869L135.373 46.5732L136.259 46.11L153.511 37.0934C178.032 24.2774 208.3 33.7665 221.116 58.2879C233.932 82.8093 224.443 113.077 199.922 125.893L182.67 134.91L181.783 135.373L182.247 136.259L191.263 153.511C204.079 178.033 194.59 208.301 170.069 221.117C145.547 233.933 115.279 224.443 102.463 199.922L93.4467 182.67L92.9835 181.784L92.0973 182.247L74.8454 191.264C50.324 204.08 20.056 194.591 7.24005 170.069C-5.57594 145.548 3.91319 115.28 28.4346 102.464L45.6865 93.4472Z" fill="#F7AEF8" stroke="#111111" stroke-width="2"/>
        </svg>  
    </div>
</section>
<section class="h-screen w-full bg-button px-6 sm:px-8 md:px-15 xl:px-[6.25rem] py-20 sm:py-30 xl:py-[8.75rem] flex flex-col justify-center gap-16">
    <p class="text-white font-display font-medium text-2xl sm:text-4xl">
        I am looking forward to jobs that are...
    </p>
...
<style lang="postcss">
    ...
    .hi-section {
        box-shadow: 7px 8px 0px 0px theme(colors.button);
        -webkit-box-shadow: 7px 8px 0px 0px theme(colors.button);
        -moz-box-shadow: 7px 8px 0px 0px theme(colors.button);
        ...
        @screen xl {
            box-shadow: 14px 15px 0px 0px theme(colors.button);
            -webkit-box-shadow: 14px 15px 0px 0px theme(colors.button);
            -moz-box-shadow: 14px 15px 0px 0px theme(colors.button);
        }
    }
</style>