...
<section class="flex items-center justify-center w-full min-h-screen px-6 py-24 overflow-hidden bg-white sm:px-8 md:px-15 lg:px-auto">
	{#if isPageLoaded}
		<div class="relative">
			...
			<svg
				transition:spin
				class="absolute right-0 -top-14 sm:-top-28 -left-12 sm:-left-28 max-h-[6rem] sm:max-h-[12rem] shape-shadow transition-transform ease-in-out duration-1000 hover:rotate-[360deg]"
				viewBox="0 0 295 295"
				fill="none"
				xmlns="http://www.w3.org/2000/svg">
				<path
