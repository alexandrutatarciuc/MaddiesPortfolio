...
<section class="w-full flex justify-center items-center h-screen px-6 sm:px-8 md:px-15 lg:px-auto overflow-hidden">
    <div class="relative text-display border-2 border-gray-900 rounded-2xl mx-auto px-4 sm:px-8 md:px-10 lg:px-15 py-12 sm:py-19 flex flex-col gap-10 max-w-[70rem] hi-section">
        ...
        <!-- Eye-shape -->
        <svg class="absolute -right-12 sm:-right-28 md:-right-16 inset-y-36 max-h-[3.5rem] sm:max-h-[5.75rem] xl:max-h-[6.75rem] shape-shadow" viewBox="0 0 195 112" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Flower shape -->
        <svg class="absolute -translate-y-1/2 -translate-x-1/2 -top-2 sm:-top-6 -left-2 sm:-left-6 max-h-[6rem] sm:max-h-[12rem] shape-shadow" viewBox="0 0 295 295" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Small cloud shape -->
        <svg class="absolute translate-y-1/2 -translate-x-1/2 -bottom-2 sm:-bottom-0 left-0 sm:-left-10 max-h-[6.25rem] sm:max-h-[10.5rem] shape-shadow" viewBox="0 0 228 228" fill="none" xmlns="http://www.w3.org/2000/svg">
